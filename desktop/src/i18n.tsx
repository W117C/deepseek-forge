...
const DICT: Record<string, { zh: string; en: string }> = {
  ...
  "pd.wrap": { zh: "包装为专业 Agent", en: "Wrap as Pro Agent" },
  "pd.wrapHint": { zh: "把此插件包装成带专业预设的 Agent，随后可一键安装", en: "Wrap this plugin into a pro-agent with a preset; installable afterwards" },
  "pd.wrapping": { zh: "包装中…", en: "Wrapping…" },
  "pd.wrapDone": { zh: "已包装：{name}", en: "Wrapped: {name}" },
  "pd.wrapFailed": { zh: "包装失败", en: "Wrap failed" },
  ...
  "db.combos": { zh: "专业 Agent 组合包", en: "Professional Agent Combos" },
  "db.installCombo": { zh: "一键安装", en: "Install" },
